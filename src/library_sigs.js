...
sigs = {
  ...
  _wasmfs_externalfs_check_mount__sig: 'vp',
  _wasmfs_externalfs_free_file__sig: 'vi',
  _wasmfs_externalfs_open_blob__sig: 'vpip',
  _wasmfs_externalfs_read_blob__sig: 'ipipiip',
  _wasmfs_fetchfs_get_child__sig: 'vpippp',
  _wasmfs_fetchfs_get_entries__sig: 'vpipp',
  _wasmfs_fetchfs_free_handle__sig: 'vi',
  _wasmfs_fetchfs_read_handle: 'ipipiip',
  _wasmfs_fetchfs_get_size_handle: 'vpip',
